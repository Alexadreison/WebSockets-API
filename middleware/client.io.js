 ...
 * Module exports.
 */
module.exports = exports = myClient;
 ...
 * params : url = string
 */ 
exports.newConnection = myClient.prototype.newConnection = function(url, options) {
    
    var self = this;
    
    self.socket = lookup(url, options);                   // new connection with its options
    ...
    self.socket.on('connect', function() {
        ...
        self.socket.emit('registerMobile', self.clientName);
    ...
    //self.socket.on('newMessage', function(data) {                           // receive new packet from client
      self.socket.on('eventMsg', function(data) {
 ...
 */
exports.newEventListener = myClient.prototype.newEventListener = function(event, listener) {
 ...
 */
exports.sendEvent = myClient.prototype.sendEvent = function(event) {
    ...
    this.socket.emit('eventMsg', dataTransmit);
 ...
 * params : name = string
 */
exports.clientName = myClient.prototype.clientName = function(name) {
 ...
 */
exports.close = myClient.prototype.close = function() {
